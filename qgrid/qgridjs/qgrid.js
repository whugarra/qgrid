define([
    ...
    'text_filter',
    'widgets/js/widget'
], function ($, _, moment, date_filter, slider_filter, text_filter, widget) {
    "use strict";

    var dependencies_loaded = false;
    var grids_to_initialize = []

    var QGrid = widget.DOMWidgetView.extend({
...
//  function (grid_elem_selector, data_frame, column_types) {
...
// Logic needs to be re-implemented in Python and communicated through the model.
